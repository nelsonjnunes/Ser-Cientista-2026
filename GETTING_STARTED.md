...
Welcome to the Ser Cientista. This guide will get you up and running in a few steps.

---

## 1. Get the materials

Go to https://github.com/nelsonjnunes/Ser-Cientista-2026, click the green **Code** button and choose **Download ZIP**. Extract the folder somewhere convenient on your machine.
